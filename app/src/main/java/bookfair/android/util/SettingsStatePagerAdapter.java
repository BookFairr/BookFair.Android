...
public class SettingsStatePagerAdapter extends FragmentStatePagerAdapter {

    //instantiating fragments by array and hashmap
    ...
    public SettingsStatePagerAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    /**
     * returns the fragment with the name @param when passed a string
     * @param fragmentName
     * @return
     */
    ...
    /**
     * overloaded function that returns the fragment with the name @param when passed an object
     * @param fragment
     * @return
     */
    ...
    /**
     * returns the fragment with the name @param when passed an integer
